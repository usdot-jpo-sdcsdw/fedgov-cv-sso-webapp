...
<c:if test="${not pageContext.request.secure}">
  <div id="msg" class="errors">
    ...
    <p>You are currently trying to access Connected Vehicles over a non-secure connection. Log-in WILL NOT WORK unless you log in over HTTPS.</p>
  </div>
</c:if>
...
<div class="box" id="login">
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <div id="icons">
    	<i id="user" class="fa fa-user fa-2x"></i>
    	<i id="lock" class="fa fa-lock fa-2x"></i>
    </div>
    ...
    <section class="row">
      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <form:input cssClass="required" cssErrorClass="error" id="username" placeholder="Username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
        </c:otherwise>
      </c:choose>
    </section>
